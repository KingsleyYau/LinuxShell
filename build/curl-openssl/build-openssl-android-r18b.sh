...
function configure_prefix {
	...
	export EXTRA_CFLAGS="-I$PREFIX/include -ffunction-sections -fdata-sections -fPIC" 
...
function build_openssl {
	...
	export LDFLAGS=""
	./Configure $ANDROID_CONFIG no-ssl2 no-ssl3 no-hw no-shared $CONFIG_PARAM --openssldir="$PREFIX" $CFLAGS \
    					|| exit 1
